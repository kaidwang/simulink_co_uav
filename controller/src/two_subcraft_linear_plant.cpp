...
#include <controller/two_subcraft_linear_plant.h>
...
linear_ava_plant::linear_ava_plant()
{
    ...
    I_platform.x = 0.0008; // inertia of linear platform
    I_platform.y = 0.2315;
    I_platform.z = 0.2308;
    ...
    // mass param
    platform_mass = 1.17; // mass of linear platform
    fly1_mass = 1.7;
    fly2_mass = 1.7;
    // fly3_mass = 1.7;
    ...
    sys_mass = fly1_mass+fly2_mass+platform_mass;
...
// compose sub-aircraft1 and sub-aircraft2 angle and thrust output to U
void linear_ava_plant::two_composition( 
...
{
    Eigen::Matrix3f r_mat0, rt_mat0, rmat1,rmat2; //main_euler_angle rotation mat
...
void linear_ava_plant::translational_kinematics()
{
    ...
    ROS_INFO_STREAM("v1_dot: "<<v1_dot);
    ROS_INFO_STREAM("v1_dot_last: "<<v1_dot_last);
