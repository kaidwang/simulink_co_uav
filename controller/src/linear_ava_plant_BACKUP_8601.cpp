...
//  fly1_position
    fly1_pos.x = 0;
    fly1_pos.y = 0;
    fly1_pos.z = 0.0124;//-0.04135;
    //fly2_positon
    fly2_pos.x = 1.1;//0.94;
    fly2_pos.y = 0;
    fly2_pos.z = 0.0124;//-0.04135;
    //fly3_positon
    fly3_pos.x = -1.1;//-0.94;
    fly3_pos.y = 0;
    fly3_pos.z = 0.0124;//-0.04135;
    // inertia of linear platform
    I_platform.x = 0.0035;//0.0011; // inertia of linear platform
    I_platform.y = 1.6250;//0.6929;
    I_platform.z = 1.2794;//0.8232;

    tool_pos.x = 0;
    tool_pos.y = 0;
    tool_pos.z = 0.0124;//-0.04135;

    // mass param
<<<<<<< HEAD
    platform_mass = 2.9;//1.67; // mass of linear platform
=======
    platform_mass = 2.3;//1.67; // mass of linear platform
>>>>>>> 93fdb78d4bab98c7221d0ea96027b91adcd1f9e1
    fly1_mass = 1.7;
    fly2_mass = 1.7;
    fly3_mass = 1.7;
