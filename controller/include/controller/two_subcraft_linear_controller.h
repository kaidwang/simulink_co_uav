...
#include <controller/two_subcraft_linear_plant.h> // linear ava plant file
...
private:
	...
	// debug publish
    geometry_msgs::Point thrust_debug;
    geometry_msgs::Point torque_debug;
